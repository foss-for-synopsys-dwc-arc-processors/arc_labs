...
At this point, the serial port debugging tool will see the serial port feedback information, reflecting the process of the EMSK development board using the AT command to establish the httpserver(as shown bellow).
...
Referring to the experiment of MRF24G WIFI module, using esp8266 and TCN75 temperature sensor to build httpserver to make the page display the sensor temperature in real time.
