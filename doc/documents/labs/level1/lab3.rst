...
* |embarc| package
* ``embarc_osp/arc_labs/lab3_timer``
...
Open the folder ``embarc_osp/arc_labs/lab3_timer``, and open the ``makefile``, here is the default configuration.
...
Open ``cmd`` under the folder *embarc_osp/arc_labs/lab3_timer*, input the compile command as follow:
...
Open ``cmd`` under the folder *embarc_osp/arc_labs/lab3_timer*, input the command as follow:
